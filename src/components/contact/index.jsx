    ...
    return (
        <div id='contact'>
            <div className='container'>
                ...
                <p data-aos='fade-left' className='desc'>I offer both Infrastructure Engineering and Fullstack Engineering services. Let me know if you want to collaborate on something! :)<br/><br/>I am also currently on the look out for job opportunities encompassing the disciplines of Infrastructure Engineering, DevOps Engineerig, Site Reliability Engineering, and Platform Engineering.<br/><br/>Send me an email by answering the form below!</p>
